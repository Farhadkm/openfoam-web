  ...
  return (
    <>
      <div className="page-desc">
        All simulation runs with their status, timestamps, and results.
      </div>

      <section className="panel">
        <div className="panel-header">
          <div className="section-title" style={{ margin: 0 }}>Run History ({jobs.length})</div>
                  ...
                  >
                    ...
                    <td style={{ textAlign: "right" }} onClick={(e) => e.stopPropagation()}>
                      <div className="row gap-sm" style={{ justifyContent: "flex-end" }}>
                        <Link className="btn secondary sm" href={`/jobs/${j.id}`} style={{ padding: "4px 8px", fontSize: 11 }}>
                          Open
                        </Link>
                        <a
                          className="btn sm"
